/**
 * The bar `colorbar` hook (plan E5.3): the bar of `marker`'s colorscale, when shown.
 */
...
export function barColorbar(trace: FullTrace, ctx: LegendIconContext): ColorbarSpec | null {
