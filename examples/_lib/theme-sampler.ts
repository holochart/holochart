 ...
 *
 * Fonts, sizes and colors all come from the theme. A family that is not registered (Open Sans,
 * Helvetica Neue, Arial, …) draws with the renderer's shipped default font (TeX Gyre Heros), so
 * baselines stay deterministic without registering any font.
 */
